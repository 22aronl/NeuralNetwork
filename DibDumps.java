...
// The color table
      ...
      DibDumps dibdumper = new DibDumps(); // needed to get to the byte swapping methods

      if (args.length > 0)
         inFileName = args[0];
      else
         inFileName = "img/IMG_0227.bmp";

      if (args.length > 1)
         outFileName = args[1];
      else
         outFileName = "input/IMG_0227.bmp";
