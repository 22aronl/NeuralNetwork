 ...
 * 
 * 
 *          List of Methods: double activationFunction(double), double derivativeActivationFunction(double), double calcError(int),
 *          void feedForward(), double getMaxError(), double getRandomNumber(double, double), void learningSet(), void
